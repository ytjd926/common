...
public class HintSpinnerAdapter implements SpinnerAdapter, ListAdapter {
     ...
     * @param hintView layout for nothing selected, perhaps
     * you want text grayed out like a prompt...
     * @param context
     */
    public HintSpinnerAdapter(
            SpinnerAdapter spinnerAdapter,
            View hintView, Context context) {
        this(spinnerAdapter, hintView, -1, context);
    }
    /**
     * Use this constructor to have NO 'Select One...' item, instead use
     * the standard prompt or nothing at all.
    ...
    public HintSpinnerAdapter(
        ...
        this(spinnerAdapter,
                LayoutInflater.from(context).inflate(hintLayout, null, false),
                -1, context);
    }
     ...
     * @param hintView layout for nothing selected, perhaps you want
    ...
    public HintSpinnerAdapter(SpinnerAdapter spinnerAdapter,
                              View hintView, int hintDropdownLayout, Context context) {
