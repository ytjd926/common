 ...
 */
public class ViewPagerWithoutPreload extends ViewGroup {
    private static final String TAG = ViewPagerWithoutPreload.class.getSimpleName();
    ...
    public ViewPagerWithoutPreload(Context context) {
        super(context);
        initViewPager();
    }

    public ViewPagerWithoutPreload(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
