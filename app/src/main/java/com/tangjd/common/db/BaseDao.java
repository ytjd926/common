...
public abstract class BaseDao<T, Integer> {
    ...
    private Map<Class<T>, Dao<T, Integer>> mDaoMap = new HashMap<>();
    //helper
    protected OrmLiteSqliteOpenHelper mDatabaseHelper;
    //上下文
    protected Context mContext;

    public BaseDao(Class<T> clazz, Context appContext) {
        this.clazz = clazz;
    ...
    public abstract OrmLiteSqliteOpenHelper getDatabaseHelper();
