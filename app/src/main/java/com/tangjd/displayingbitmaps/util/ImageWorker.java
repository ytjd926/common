...
//        if (mImageCache != null) {
//            value = mImageCache.getBitmapFromMemCache(ImageCache.getCacheKey(String.valueOf(data), getWith(), getHeight()));
//        } else {
...
//            Log.e(TAG, "mem cache hit cacheKey=" + ImageCache.getCacheKey(String.valueOf(data), getWith(), getHeight()));
...
//            }
//
//            String cacheKey = ImageCache.getCacheKey(dataString, getWith(), getHeight());
//
...
//                if (bitmap != null) {
//                    Log.e(TAG, "doInBackground - diskcache hit cacheKey=" + cacheKey);
//                    drawable = getBitmapDrawable(bitmap);
//                    if (mImageCache != null) {
//                        mImageCache.addBitmapToMemCache(cacheKey, drawable);
//                    }
//                }
//            }
//
...
//                if (bitmap != null) {
//                    Log.e(TAG, "doInBackground - http disk cache or download hit,  cacheKey=" + cacheKey);
//                    drawable = getBitmapDrawable(bitmap);
//                    if (mImageCache != null) {
//                        mImageCache.addBitmapToMemCache(cacheKey, drawable);
//                        mImageCache.addBitmapToDiskCache(cacheKey, drawable);
//                    }
//                }
//            }
//
