...
package com.tangjd.displayingbitmaps.util;
...
public class ImageCache {
    ...
    public void addBitmapToMemCache(String cacheKey, BitmapDrawable value){
        ...
        if (mMemoryCache != null) {
            ...
            mMemoryCache.put(cacheKey, value);
        }
    }

    public void addBitmapToDiskCache(String cacheKey, BitmapDrawable value){
        if (cacheKey == null || value == null) {
            return;
        }
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null) {
                final String key = hashKeyForDisk(cacheKey);
    ...
    public BitmapDrawable removeBitmapFromMemCache(String data) {
        return mMemoryCache.remove(data);
    }
    ...
    public static File getExternalCacheDir(Context context) {
        ...
        final String cacheDirPath = "/Android/data/" + context.getPackageName() + "/cache/";
        return new File(Environment.getExternalStorageDirectory().getPath() + cacheDirPath);
    }
    ...
    public static String getCacheKey(String url, int maxWidth, int maxHeight) {
        return getCacheKey(url, maxWidth, maxHeight, ImageView.ScaleType.CENTER_INSIDE);
    }
